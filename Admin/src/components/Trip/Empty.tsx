  ...
  return (
    <div className="h-[32rem] flex flex-col space-y-2 justify-center items-center">
      ...
      {location.pathname === "/buses" && (
        <button className="my-1 w-[130px] text-white bg-emerald-500 bg-gradient-to-r from-[#5651e5] to-[#709dff] font-medium rounded-lg text-sm px-5 py-2.5 text-center hover:scale-[1.02] transition-transform">
